      ...
      <div className="min-h-screen bg-black text-gray-300">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-md text-gray-400 mt-6 mb-15">
        ...
        <section id="join-us" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-800 via-gray-900 to-black relative overflow-hidden">
          <div className="absolute inset-0 opacity-5">
            <div className="absolute top-40 left-20 w-96 h-96 bg-purple-500 rounded-full blur-4xl"></div>
            <div className="absolute bottom-30 right-20 w-1/2 h-2/3 bg-purple-400 rounded-full blur-4xl"></div>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-800 via-gray-900 to-black relative overflow-hidden">
          <div className="absolute inset-0 opacity-3">
            <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-purple-600 rounded-full blur-4xl"></div>
